...
export const addInitialReferences = () => {
    const references = [
        ...
        { name: "Emicida", biography: "Rapper, cantor e compositor, conhecido por suas letras engajadas e seu impacto na música brasileira contemporânea.", category: "Músico", photo_url:"https://noticiapreta.com.br/wp-content/uploads/2020/04/foto-julia-rodrigues-reproducao.jpg" },
        { name: "Fernando Holiday", biography: "Vereador de São Paulo e ativista político, conhecido por seu trabalho na política brasileira.", category: "Político", photo_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRotERGJ_d4qN3IKiTTnoE4dhn1bBMe2u6AKA&s" },
